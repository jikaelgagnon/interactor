...
that match the corresponding selectors, it will track `#chip-container" interactions on `https://youtube.com` and it will track `#like-button[is-shorts]` and `#dislike-button[is-shorts]`.
